...
Remote sensing and Earth scientist with 8+ years experience leveraging remote sensing, machine learning, and statistical modeling to provide data-driven solutions to geospatial and environmental problems.

## SKILLS

**Programming:** Python, R, geopandas, xarray, sf, terra, data visualization \
**Computing:** High-performance computing, version control, Linux environments \
**Statistics:** Geospatial analysis, machine learning, probabilistic programming, uncertainty assessment \
